...
DEPENDS:append:milkv-duo256m = " xxd-native"
...
# milkv-duo-s: Upstream U-Boot v2026.01 with Duo S board support
# Board files added as SRC_URI (no patch hunks for existing files)
# Kconfig source lines added via do_configure
SRC_URI:milkv-duo-s = " \
            git://source.denx.de/u-boot/u-boot.git;protocol=https;branch=master \
            file://0001-riscv-sophgo-Add-CV1813H-SoC-base-support.patch \
            file://0002-riscv-sophgo-Add-Milk-V-Duo-S-board-support.patch \
...
# milkv-duo256m: Upstream U-Boot v2026.01 with Duo 256M board support
# Board support added via patches (base SoC support + board-specific files)
SRC_URI:milkv-duo256m = " \
            git://source.denx.de/u-boot/u-boot.git;protocol=https;branch=master \
            file://0001-riscv-sophgo-Add-CV1813H-SoC-base-support.patch \
            file://0003-riscv-sophgo-Add-Milk-V-Duo-256M-board-support.patch \
            file://uEnv-milkv-duo256m.txt \
            "
SRCREV:milkv-duo256m = "127a42c7257a6ffbbd1575ed1cbaa8f5408a44b3"
LIC_FILES_CHKSUM:milkv-duo256m = "file://Licenses/README;md5=2ca5f2c35c8cc335f0a19756634782f1"
ERROR_QA:remove:milkv-duo256m = "patch-fuzz"
WARN_QA:append:milkv-duo256m = " patch-fuzz"
...
do_deploy:append:milkv-duo256m() {
    if [ -f "${UNPACKDIR}/uEnv-milkv-duo256m.txt" ]; then
        cp ${UNPACKDIR}/uEnv-milkv-duo256m.txt ${DEPLOYDIR}/uEnv.txt
    fi
    install -m 0644 ${B}/u-boot.dtb ${DEPLOYDIR}
}
